...
// Pegando o id passado na url e os dados do database relacinados ao id passado
if(isset($_GET['id'])) {
...
<div class="row">
    <div class="col s12 m6 push-m3"> <!-- no small ele ocupa 12 e médio pra cima é 6 com push de 3 dos lados, centralizando a tabela -->
        <h3 class="light">Editar cliente</h3>     <!-- light deixa o título mais suave, tira o bold -->
